...
class Parser(argparse.ArgumentParser):
    def __init__(self):
        ...
        # hyperparameters
        self.add_argument('--epochs', '-e', type=int, default=10000, help="number of epochs, constant over steps")
        ...
        self.add_argument('--obs_dim', '-o', type=int, default=1, help='dimension of observation space')
        self.add_argument('--control_dim', '-c', type=int, default=1, help='dimension of control space')
