...
class Parser(argparse.ArgumentParser):
    def __init__(self):
        ...
        # hyperparameters
        self.add_argument('--epochs', '-e', type=int, default=94, help="number of epochs, constant over steps")
        ...
        # learning
        self.add_argument('--learning_horizon', '-T', type=int, default=60, help='horizon of learning')
        self.add_argument('--AB_horizon', '-m', type=int, default=50, help='number of values used to compute A and B')
        ...
        self.add_argument('--obs_dim', '-o', type=int, default=100, help='dimension of observation space')
