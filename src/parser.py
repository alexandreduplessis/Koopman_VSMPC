...
class Parser(argparse.ArgumentParser):
    ...
    def __init__(self):
        ...
        self.add_argument('--steps', '-s', type=int, default=2, help="number of training data")
        ...
        self.add_argument('--regularization', '-rho', type=float, default=1e-4, help='ADAM weight decay')
        ...
        self.add_argument('--embed_dim', '-n', type=int, default=18, help='dimension of latent space')
